                      ...
                      <div class="col-md-6 col-lg-7 d-flex align-items-center">
                        <div class="card-body p-4 p-lg-5 text-black">
          					 <c:if test="${not empty messageRegister}">
   							 <input type="hidden" id="message" value="${messageRegister }">
                        <input type="hidden" id="type" value="${typeRegister }">
						</c:if>
                          <form action="register" method="post">
                            ...
                            <div class="form-outline mb-4">
                              ...
                              <input type="password" id="form2Example27" class="form-control form-control-lg" name="password" value="${password }"/>
                              
                            </div>
                            <div class="form-outline mb-4">
                                <label class="form-label" for="form2Example27"><i class="fa-solid fa-repeat"></i> Nhập lại mật khẩu</label>
                              <input type="password" id="form2Example27" class="form-control form-control-lg" name="re-password" value="${repassword }" />
                            </div>
                            <div class="form-outline mb-4">
