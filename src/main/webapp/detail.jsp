    ...
    <div class="row">
            ...
            <div id="carouselExampleIndicators" class="carousel slide detail-giantrai" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active anhsp-detail">
                    <img class="d-block w-100" src="${pageContext.request.contextPath}/files/${p.anh}" alt="First slide">
                  </div>
                  <div class="carousel-item anhsp-detail">
                    <img class="d-block w-100" src="${pageContext.request.contextPath}/files/${p.anh}" alt="Second slide">
                  </div>
                  <div class="carousel-item anhsp-detail">
                    <img class="d-block w-100" src="${pageContext.request.contextPath}/files/${p.anh}" alt="Third slide">
                  </div>
                </div>
        ...
        <div class="col-md-6">
         <c:if test="${not empty messageCart}">
   						<input type="hidden" id="message" value="${messageCart }">
                        <input type="hidden" id="type" value="${typeCart }">
						</c:if>
        	<form action="detail?sanpham=${p.id }" method="POST">
